export const FULL_BODY_SWAP_PROMPT = [
  ...
  "Do not blend in the original person's face, skin, hair, clothes, or limbs; do not create duplicate limbs, extra fingers, warped hands, flicker, partial swaps, or identity drift.",
