  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-xl font-semibold text-white text-center mb-1 tracking-tight">Create your account</h1>
        <p className="text-neutral-500 text-sm text-center mb-6">Create your account to start streaming</p>
